---
name: "source-command-package-plans-sync"
description: "Migrated source command `package-plans-sync`"
---

# source-command-package-plans-sync

Use this skill when the user asks to run the migrated source command `package-plans-sync`.
