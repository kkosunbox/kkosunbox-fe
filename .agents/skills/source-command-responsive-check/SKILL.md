---
name: "source-command-responsive-check"
description: "Migrated source command `responsive-check`"
---

# source-command-responsive-check

Use this skill when the user asks to run the migrated source command `responsive-check`.

## Command Template

지정한 파일(인자 없으면 현재 git 변경 파일 전체)에서 AGENTS.md의 반응형 규칙 위반을 검사한다.
...
### 4. 브레이크포인트 기준 준수
- `AGENTS.md` 기준: sm=360px, md=768px, lg=1200px, xl=1440px
