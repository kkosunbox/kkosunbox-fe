...
| `--color-about-cta-bg` | `#FCF4E7` | About CTA 섹션 배경 |
| `--color-about-hero-bg` | `#FFF2D8` | About Hero 섹션 배경 |
...
| `--color-auth-mobile-tab-track` | `rgba(232, 215, 190, 0.7)` | 모바일 로그인/회원가입 토글 트랙 |
