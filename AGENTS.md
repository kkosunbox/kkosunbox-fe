...
- 상세 내용: `.Codex/contexts/design-system.md`, `.Codex/contexts/typography.md`
...
3. `.Codex/contexts/design-system.md` 토큰 표에 추가
...
- 상세 전략·도메인별 체크리스트: `.Codex/contexts/error-handling.md`
