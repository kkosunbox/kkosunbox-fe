...
|---|---|---|---|
| 모바일 | `max-md:` | < 900px | `BREAKPOINT_MD_PX` |
| 태블릿 | `md:` ~ `max-lg:` | 900px – 1199px | `BREAKPOINT_MD_PX` / `BREAKPOINT_LG_PX` |
| 데스크탑 | `lg:` | ≥ 1200px | `BREAKPOINT_LG_PX` |
...
```tsx
// ✅ 올바른 패턴
className="max-md:hidden"   // 태블릿·데스크탑 전용 (모바일 <900px 에서 숨김)
className="lg:hidden"       // 모바일·태블릿 전용 (데스크탑 ≥1200px 에서 숨김)
className="max-lg:hidden"   // 데스크탑 전용 (모바일·태블릿 <1200px 에서 숨김)
...
// mobileVariant는 <900px(모바일)에서 적용됨
