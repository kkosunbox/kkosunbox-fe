...
|---|---|---|---|
| 모바일 | `max-md:` | < 834px | `BREAKPOINT_MD_PX` |
| 태블릿 | `md:` ~ `max-lg:` | 834px – 1199px | `BREAKPOINT_MD_PX` / `BREAKPOINT_LG_PX` |
...
```tsx
// ✅ 올바른 패턴
className="max-md:hidden"   // 태블릿·데스크탑 전용 (모바일 <834px 에서 숨김)
...
// mobileVariant는 <834px(모바일)에서 적용됨
