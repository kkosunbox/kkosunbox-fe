...
const BREEDS: DogBreedItem[] = [
  ...
  { name: "벨지안 셰퍼드 독", englishName: "Belgian Shepherd Dog", aliases: ["벨기에 쉽독", "벨지안 쉽독"] },
  ...
  { name: "시앙 프랑세즈", englishName: "Chien Français", aliases: ["시잉프랑세즈"] },
  ...
  { name: "오브차카", englishName: "Caucasian Shepherd Dog", aliases: ["코카시안 오브차카", "코카시안오브차카", "카프카스 목양견"] },
  ...
  { name: "웨스트 하이랜드 화이트 테리어", englishName: "West Highland White Terrier", aliases: ["웨스티", "화이트 테리어", "화이트테리어"] },
  ...
  { name: "잉글리쉬 포인터", englishName: "English Pointer", aliases: ["잉글리시 포인터", "포인터"] },
  // ㅈ
  { name: "자이언트 슈나우저", englishName: "Giant Schnauzer", aliases: ["자이언트 슈나우져", "자이언트 슈나유져"] },
  { name: "잭 러셀 테리어", englishName: "Jack Russell Terrier" },
  { name: "저먼 셰퍼드 독", englishName: "German Shepherd Dog", aliases: ["독일 셰퍼드", "셰퍼드"] },
