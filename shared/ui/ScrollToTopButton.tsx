...
export default function ScrollToTopButton() {
  ...
  return (
    <button
      ...
      onClick={handleClick}
      aria-label="맨 위로 이동"
      className={`fixed right-4 z-40 flex h-12 w-12 items-center justify-center rounded-[8px] border border-[var(--color-text-muted)]/25 bg-white/85 text-[var(--color-text)] shadow-[0_2px_8px_rgba(0,0,0,0.06)] backdrop-blur-[2px] transition-[opacity,transform] duration-200 ease-out active:scale-95 md:hidden lg:hidden ${
        isPastViewport
