...
export default function DeliveryReviewModal({ onClose, onConfirm }: Props) {
  return (
    <div
      ...
      >
        ...
        <div
          className="relative
                     ...
                     rounded-[24px]
                     max-md:pt-[110px] md:pt-[128px] lg:pt-[128px]
                     pb-6 px-6
                     flex flex-col items-center"
          style={{ background: "var(--gradient-modal-review)" }}
        >
          <button
            onClick={onClose}
            aria-label="닫기"
          ...
          >
            <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M12.5 1.5L1.5 12.5M1.5 1.5L12.5 12.5" stroke="#999999" strokeWidth="2" strokeLinecap="round" />
            </svg>
          </button>
          ...
          <p className="mt-5 max-md:text-[13px] md:text-[14px] lg:text-[14px] font-medium leading-[160%] tracking-[-0.04em] text-[var(--color-text)] text-center">
            받아보신 상품은 만족스러우셨나요?<br />
            리뷰를 남겨주시면 더 나은 서비스로 보답하겠습니다!
          </p>

          <button
            onClick={onConfirm ?? onClose}
            className="mt-7 w-full h-[48px] rounded-[8px] bg-white
