...
export default function MemberWithdrawModal({ onClose, onConfirm }: Props) {
  return (
    <div
    ...
    >
      ...
      >
        ...
        <Image
          src="/images/modal/custom-modal-07-upper.webp"
          alt="경고 아이콘"
          width={210}
          height={210}
        ...
        <div
          ...
          style={{ background: "var(--gradient-modal-danger)" }}
        >
          {/* Close button */}
          <button
            onClick={onClose}
          ...
          <p className="mt-5 max-md:text-[13px] md:text-[14px] lg:text-[14px] font-medium leading-[160%] tracking-[-0.04em] text-white text-center">
            지금 탈퇴하시면 그동안 쌓인 혜택과<br />맞춤 건강 데이터가 모두 삭제됩니다.
          </p>
