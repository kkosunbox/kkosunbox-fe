...
const STATS = [
  {
    icon:
      ...
      >
        <path d="M26.6666 8L11.9999 22.6667L5.33325 16" stroke="var(--color-secondary)" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    , label: "1:1 맞춤 케어"
  },
  {
  ...
  },
  {
    icon: (
      <svg
        ...
        xmlns="http://www.w3.org/2000/svg"
      >
      <circle cx="20" cy="9" r="5" stroke="var(--color-secondary)" strokeWidth="2" />
      <circle cx="14" cy="20" r="4" stroke="var(--color-secondary)" strokeWidth="2" />
      <circle cx="7" cy="11" r="3" stroke="var(--color-secondary)" strokeWidth="2" />
    </svg>
    )
    , label: "인공첨가물 0%"
  },
...
export default function StatsBar() {
  return (
    <section className="bg-[var(--color-footer-bg)] max-md:py-3 md:py-4">
      <div className="mx-auto flex max-w-content items-center justify-between max-md:gap-3 md:gap-0 px-4 md:px-20 max-md:max-w-[510px]">
        {STATS.map((item, i) => (
