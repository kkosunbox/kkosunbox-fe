...
export function SubscriptionCard({ subscriptions }: { subscriptions: UserSubscriptionDto[] }) {
  ...
  if (subscriptions.length === 0) {
    return (
      <div className="flex rounded-[20px] max-md:bg-white max-md:px-5 max-md:py-5 md:bg-[var(--color-surface-light)] lg:bg-[var(--color-surface-light)] md:min-h-[173px] lg:min-h-[173px] md:px-6 lg:px-6 md:py-5 lg:py-5">
        <SubscriptionEmpty />
      </div>
    );
  }
  ...
  return (
    <div>
      <div
        className="relative flex rounded-[20px] max-md:bg-white md:h-[173px] lg:h-[173px] md:bg-[var(--color-background)] lg:bg-[var(--color-background)]"
      ...
      >
        ...
        >
          ...
          <div className="relative max-md:w-[100px] md:w-[160px] lg:w-[160px] shrink-0 self-stretch overflow-hidden rounded-l-[20px]">
            <Image
          ...
          {/* 텍스트 콘텐츠 */}
          <div className="flex min-w-0 flex-1 flex-col justify-center gap-2 max-md:px-4 max-md:py-5 md:px-8 lg:px-8">
            <div className="flex items-center gap-2">
              <span
                className="inline-flex h-[24px] w-fit shrink-0 items-center rounded-full px-[12px] max-md:text-body-13-sb md:text-body-14-sb lg:text-body-14-sb leading-[1] text-white"
                style={{ background: planTheme.colorVar }}
              >
                {planTheme.tierLabel}
              </span>
              <span
                className="max-md:text-body-13-sb md:text-body-14-sb lg:text-body-14-sb leading-[1]"
        ...
        <Link
          ...
          className="absolute right-8 top-5 z-10 max-md:text-body-13-sb md:text-body-14-sb lg:text-body-14-sb text-[var(--color-accent)] underline transition-opacity hover:opacity-80"
        >
          구독관리
        </Link>
        ...
        <SubscriptionCarouselIndicator
          ...
          className="absolute bottom-4 left-0 right-0 md:translate-x-8 lg:translate-x-8 max-md:hidden"
        />
      </div>
      ...
      <SubscriptionCarouselIndicator
        ...
        total={subscriptions.length}
        onSelect={setActiveIndex}
        className="pt-3 md:hidden lg:hidden"
      />
    </div>
  );
}
