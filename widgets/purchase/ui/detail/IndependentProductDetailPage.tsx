...
export default function IndependentProductDetailPage({ product }: { product: ProductDto }) {
  ...
  async function handleAddToCart() {
    ...
    try {
      ...
      notifyCartUpdated();
      openAlert({ type: "success", title: "장바구니에 담았습니다.", primaryLabel: "장바구니 보기", onPrimary: () => router.push("/cart"), secondaryLabel: "계속 쇼핑하기" });
