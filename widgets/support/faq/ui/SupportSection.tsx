...
const FAQ_ITEMS: FaqItem[] = [
  ...
  },
  {
    ...
    answer:
      "유통기한은 제품에 별도 표기됩니다. 건조간식은 냉장 7일, 그 외 화식과 간식류는 냉장 3일간 보관할 수 있으며, 모두 냉동 시 2개월까지 보관 가능합니다.",
    fullAnswer:
      "유통기한은 제품에 별도 표기됩니다. 개봉 후에는 가급적 빨리 급여해 주세요. 건조간식은 냉장 7일, 냉동 2개월까지 보관할 수 있으며, 그 외 화식과 간식류는 냉장 3일, 냉동 2개월까지 보관 가능합니다. 실온 보관 시 변질될 우려가 있으니 반드시 냉장 또는 냉동 보관해 주세요.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "정기 구독은 신용카드와 체크카드로 결제할 수 있으며, 단품은 신용카드, 체크카드와 네이버페이, 카카오페이, 토스페이를 지원합니다.",
    fullAnswer:
      "정기 구독은 신용카드와 체크카드로 결제할 수 있으며, 등록된 카드로 매월 자동 결제됩니다. 단품은 신용카드, 체크카드와 간편결제인 네이버페이, 카카오페이, 토스페이를 모두 이용할 수 있습니다.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "간식에 사용되는 원재료의 원산지는 상품별로 다르며, 자세한 원산지와 성분은 제품 패키지에서 확인하실 수 있습니다.",
    fullAnswer:
      "간식에 사용되는 원재료의 원산지는 상품별로 다릅니다. 각 제품의 원산지와 성분은 제품 패키지에 상세히 표기되어 있으니 급여 전에 확인해 주세요. 원재료에 대한 자세한 정보가 필요하시면 고객센터로 문의해 주세요.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "네, 선물 수령인 정보로 배송지를 설정하시면 구독 상품을 선물로 보내실 수 있습니다.",
    fullAnswer:
      "네, 선물 수령인 정보로 배송지를 설정하시면 구독 상품을 선물로 보내실 수 있습니다. 주문 전 수령인의 이름, 연락처와 배송지 정보를 정확히 확인해 주세요.",
  },
];
